package com.restaurant.edgeservice.config;
...
class SecurityConfigTests {
	...
	private ClientRegistration testClientRegistration() {
		return ClientRegistration.withRegistrationId("test")
				...
				.clientId("test")
				.authorizationUri("https://sso.tastyrestaurant.com/auth")
				.tokenUri("https://sso.tastyrestaurant.com/token")
				.redirectUri("https://tastyrestaurant.com")
				.build();
	}
