package com.restaurant.edgeservice.user;

import java.util.List;

import com.restaurant.edgeservice.config.SecurityConfig;
...
class UserControllerTests {
	...
	void whenAuthenticatedThenReturnUser() {
		var expectedUser = new User("harry.potter", "Harry", "Potter", List.of("employee", "customer"));
